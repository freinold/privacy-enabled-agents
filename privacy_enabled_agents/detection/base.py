...
class BaseDetector(RunnableSerializable[DetectorInput, DetectorOutput], ABC):
    """
    ...
    def invoke(
        ...
        **kwargs: Any,
        ...
        Args:
            input (DetectorInput): The input to be analyzed.
            config (Optional[RunnableConfig], optional): Configuration for the detection process. Defaults to None.

        Returns:
            DetectorOutput: The output of the detection process.
        """
        pass
    ...
    def batch(
        ...
        **kwargs: Any,
        ...
        Args:
            inputs (Sequence[DetectorInput]): A sequence of inputs to be processed by the detector.
            config (Union[RunnableConfig, list[RunnableConfig], None], optional): Configuration(s) for the detector. Defaults to None.
            threshold (Optional[float], optional): Threshold for the model to consider an entity as a PII entity. Defaults to None.

        Returns:
            list[DetectorOutput]: A list of outputs generated by the detector for the given inputs.
        """
        pass
